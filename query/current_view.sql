...
-- These queries run on Iceberg tables that Tableflow keeps fresh from Kafka.
-- History from three days ago and a scan from three seconds ago are the same table.
