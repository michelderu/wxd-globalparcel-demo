...
Do the business work **on the stream**, then land it in the engines that run this workshop.
...
4. Write **once** into each fit-for-purpose store.
...
Hands-on with the same UIs and schema: [`../../03-realtime-operations/README.md`](../../03-realtime-operations/README.md).
