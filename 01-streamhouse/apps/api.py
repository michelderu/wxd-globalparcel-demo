...
- /tower/        current view of the business (warehouse materialization)

Ask the business in session 04 (watsonx Orchestrate).
"""
...
ops_frontend = WORKSHOP_ROOT / "03-realtime-operations" / "frontend"
