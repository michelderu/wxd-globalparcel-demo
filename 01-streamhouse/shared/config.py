...
STREAMHOUSE_DIR = Path(__file__).resolve().parent.parent
WORKSHOP_ROOT = STREAMHOUSE_DIR.parent
REPO_ROOT = STREAMHOUSE_DIR
DATA_DIR = Path(os.environ.get("STREAMHOUSE_DATA", STREAMHOUSE_DIR / "data"))
