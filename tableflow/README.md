...
**IBM query plane:** after this laptop materialization, session 01 loads the same business into **watsonx.data** Iceberg and federates PostgreSQL surcharge rows. See [`../01-data-federation/README.md`](../01-data-federation/README.md).
